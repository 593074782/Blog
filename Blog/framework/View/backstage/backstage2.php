...
<body>
	...
	<div class="allmessage" id="diary">
		...
		<div class="WriteDiary" id="WriteDiary">  <!-- 写日志的界面 -->
			...
			<div>
				<div>
					<input type="text" name="diary_title" maxlength="10" placeholder="请输入日志标题" class="totitle" id="title" onblur="text()" onkeydown="text()">
	 			</div>
				<div>
	...
	<div class="allmessage" id="linkes">
		...
		<div class="WriteDiary" id="Writelink">  <!-- 添加链接 -->
			<form method="post" action="../../Controller/" class="toform">
			<div>
				<div>
